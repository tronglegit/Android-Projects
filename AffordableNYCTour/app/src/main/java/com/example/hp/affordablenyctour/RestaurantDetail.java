...
public class RestaurantDetail extends ActionBarActivity implements View.OnClickListener {
    ...
    int [] images ={R.drawable.big1,R.drawable.big2,R.drawable.big3,R.drawable.big4,R.drawable.big5};
    ...
    public void getthereClick(View view) {
    ...
    public void phoneClick(View view) {
        ...
        phoneBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                phone.setData(Uri.parse("tel:2129640540"));
                startActivity(phone);
            }
        });
